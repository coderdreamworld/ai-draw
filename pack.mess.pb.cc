...
namespace protobuf_pack_2emess_2eproto {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "pack.mess.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
helloworld::helloworld()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_pack_2emess_2eproto::InitDefaults();
  }
  SharedCtor();
...
const ::google::protobuf::Descriptor* helloworld::descriptor() {
  protobuf_pack_2emess_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_pack_2emess_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata helloworld::GetMetadata() const {
  protobuf_pack_2emess_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_pack_2emess_2eproto::file_level_metadata[kIndexInFileMessages];
}
